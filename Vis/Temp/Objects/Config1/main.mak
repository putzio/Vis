...
export WIN32_AS_PROJECT_PATH := "D:\Studia\VI\Vis\Vis"
export WIN32_AS_SYSTEM_PATH := "C:\BrAutomation\AS\System"
export WIN32_AS_VC_PATH := "C:\BrAutomation\AS49\AS\VC"
export WIN32_AS_TEMP_PATH := "D:\Studia\VI\Vis\Vis\Temp"
export WIN32_AS_BINARIES_PATH := "D:\Studia\VI\Vis\Vis\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/4.9/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/Vis.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'BuildAndTransfer'   
